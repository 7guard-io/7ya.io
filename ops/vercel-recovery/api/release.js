...
module.exports = (_request, response) => {
  ...
  if (!sourceSha) {
    respond(response, 503, {
      ...
      repair: 'Build from a provider-linked Git deployment so release-manifest.json receives a provider-generated commit SHA.',
    });
    return;
  }
  ...
  respond(response, 200, {
    ...
    release: manifest.release || DEFAULT_RELEASE,
    source_repository: '7guard-io/7ya.io',
    source_branch: manifest.source_branch || null,
    source_path: 'ops/vercel-recovery',
    source_sha: sourceSha,
