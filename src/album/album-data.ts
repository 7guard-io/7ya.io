...
export const coverMedia: AlbumMedia = {
    id: 'cover-owner-archive',
    src: 'https://7ya.io/resources/drive-life-photo.jpg',
    kind: 'photo',
    alt: l('איגור ופרצקי — צילום אישי מארכיון 7YA', 'Igor Vepretski — personal photo from the 7YA archive', 'Игорь Вепрецкий — личное фото из архива 7YA'),
    caption: l('צילום אישי · ארכיון 7YA', 'Personal photo · 7YA owner archive', 'Личное фото · архив 7YA'),
    sourceUrl: 'https://7ya.io/resources/drive-life-photo.jpg',
    sourceLabel: '7YA · OWNER ARCHIVE · ORIGINAL PHOTO',
