...
const guideStyleTag = '<link rel="stylesheet" href="/styles/7ya-signal-key-20260715.css?v=20260920-speak1" data-7ya-signal-key-assets="20260715">';
const guideScriptTag = '<script src="/scripts/7ya-signal-key-20260715.js?v=20260920-speak1" data-7ya-signal-key-assets="20260715" defer></script>';
...
function injectSharedAssets(html, relative) {
  ...
  html = html
    .replace(/\/styles\/7ya-signal-key-20260715\.css(?:\?[^"'\\s>]*)?/g, '/styles/7ya-signal-key-20260715.css?v=20260920-speak1')
    .replace(/\/scripts\/7ya-signal-key-20260715\.js(?:\?[^"'\\s>]*)?/g, '/scripts/7ya-signal-key-20260715.js?v=20260920-speak1');
