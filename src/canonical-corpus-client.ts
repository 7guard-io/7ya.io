...
const bundledCorpus:CorpusEvent[]=mergePublicRegisterIntoCanon(mergeDigitalCompendiumIntoCanon(canonicalCorpusSeed)).filter(item=>item.visibility==='public').sort((a,b)=>a.storyOrder-b.storyOrder);
