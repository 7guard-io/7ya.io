...
const copy={
 he:{media:'מדיה מקורית',owned:'שלי',external:'חיצוני',record:'רשומה',undated:'תאריך לא הושלם',source:'למקור ↗',fallback:'הקורפוס החברתי לא נטען כרגע — מוצגת תצוגת גיבוי מחוברת למקורות.'},
 en:{media:'Original media',owned:'Owned',external:'External',record:'Record',undated:'Date unresolved',source:'Open source ↗',fallback:'The social corpus is unavailable right now — showing a source-linked fallback view.'},
 ru:{media:'Оригинальное медиа',owned:'Моё',external:'Внешнее',record:'Запись',undated:'Дата не определена',source:'Открыть источник ↗',fallback:'Социальный корпус сейчас недоступен — показана резервная версия со ссылками на источники.'},
 ar:{media:'وسائط أصلية',owned:'مملوك',external:'خارجي',record:'سجل',undated:'التاريخ غير محدد',source:'فتح المصدر ↗',fallback:'المجموعة الاجتماعية غير متاحة حالياً — يتم عرض نسخة احتياطية مرتبطة بالمصادر.'}
 }[lang]||null;
const c=copy||{media:'Original media',owned:'Owned',external:'External',record:'Record',undated:'Date unresolved',source:'Open source ↗',fallback:'The social corpus is unavailable right now.'};
